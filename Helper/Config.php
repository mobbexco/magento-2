...
class Config extends \Magento\Framework\App\Helper\AbstractHelper
{
    ...
    public $settingPaths = [
        ...
        'order_status_partial_refund' => 'payment/webpay/checkout/order_status_settings/order_status_partial_refund',
        'disable_invoices'            => 'payment/webpay/checkout/order_status_settings/disable_invoices',
        'partial_refund_status'       => 'payment/webpay/checkout/order_status_settings/partial_refund_status',
    ];
